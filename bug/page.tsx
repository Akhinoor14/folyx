...
export default function BossElectronicsPage() {
  ...
  const save = async () => {
    ...
    const res = await fetch('/api/github',{method:'PUT',headers:{'Content-Type':'application/json'},
  ...
  const remove = async (id:string) => {
    ...
    await fetch('/api/github',{method:'PUT',headers:{'Content-Type':'application/json'},
      body:JSON.stringify({clientId,path:'projects/electronics.json',content:JSON.stringify(updated,null,2)})})
    setProjects(updated)
  }
